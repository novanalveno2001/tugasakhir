...
import 'package:tugasakhir/databuku/terlaris.dart';
...
class BukuTerlaris extends StatefulWidget {
  static const String routeName = '/buku_terlaris';

  @override
  _BukuTerlarisState createState() => _BukuTerlarisState();
}

class _BukuTerlarisState extends State<BukuTerlaris> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Daftar Buku Terlaris'),
      ),
      drawer: MenuDrawer(),
      body: grid,
    );
